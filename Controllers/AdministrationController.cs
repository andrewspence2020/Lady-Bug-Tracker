...
namespace BugTracker.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> ManageUserClaims(UserClaimsViewModel model)
        {
            ...
            if (!result.Succeeded)
            {
                ModelState.AddModelError("", "Cannot remove user existing in cliams");
                return View(model);
            }
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                {
                    //This logs the message in the log file
                    logger.LogError($"Error deleting role{ex}");
                    ViewBag.ErrorTitle = $"{role.Name} role is in use";
                    ViewBag.ErrorMessage = $"{role.Name} role cannot be deleted as there are users " +
                        $" in this role. If you want to delete this role,Please remove the uses" +
                        $" from the role and then try to delete again";
                    return View("Error");
                }
            }
        }
